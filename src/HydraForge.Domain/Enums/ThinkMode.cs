...
/// <summary>
/// Per-model override for whether routed LLM calls request thinking/reasoning mode.
/// Thinking-capable models put reasoning in a separate response field from the

...
public interface IProjectDocumentRepository
{
    ...
    Task<IReadOnlyList<ProjectDocument>> ListByProjectAsync(
        Guid projectId,
        CancellationToken ct = default
    );
    Task<ProjectDocument?> GetByDocTypeAsync(
        Guid projectId,
    ...
    Task<IReadOnlyList<ProjectDocumentVersion>> ListVersionsAsync(
        Guid documentId,
        CancellationToken ct = default
    );

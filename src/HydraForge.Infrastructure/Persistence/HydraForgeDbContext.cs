...
public class HydraForgeDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureEntity<Spec>(modelBuilder, "specs", b =>
        {
            ...
            b.Property(e => e.DocType).HasColumnName("doc_type").HasConversion<int>().HasDefaultValue(DocType.Specification).HasSentinel(default(DocType)).IsRequired();
        ...
        ConfigureEntity<Plan>(modelBuilder, "plans", b =>
        {
            ...
            b.Property(e => e.Status).HasColumnName("status").HasConversion<int>().HasDefaultValue(PlanStatus.Pending).HasSentinel(default(PlanStatus)).IsRequired();

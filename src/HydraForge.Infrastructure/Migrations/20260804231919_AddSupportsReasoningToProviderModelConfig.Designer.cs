...
namespace HydraForge.Infrastructure.Migrations
{
    ...
    [Migration("20260804231919_AddSupportsReasoningToProviderModelConfig")]
    partial class AddSupportsReasoningToProviderModelConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HydraForge.Domain.Entities.Chat.ChatSession", b =>
                {
                    ...
                    b.Property<bool>("SearchAllMyDocs")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HydraForge.Domain.Entities.Chat.ChatSessionDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SessionId", "DocumentId")
                        .IsUnique();

                    b.ToTable("chat_session_documents", (string)null);
                });

            modelBuilder.Entity("HydraForge.Domain.Entities.Chat.PromptPreset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HydraForge.Domain.Entities.Chat.PromptPresetGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("prompt_preset_groups", (string)null);
                });
            ...
            modelBuilder.Entity("HydraForge.Domain.Entities.Chat.ChatSession", b =>
                {
                    b.HasOne("HydraForge.Domain.Entities.PersonalSpace.AgentPersonality", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HydraForge.Domain.Entities.Chat.PromptPreset", b =>
                {
                    b.HasOne("HydraForge.Domain.Entities.Chat.PromptPresetGroup", null)
                        .WithMany()

...
namespace HydraForge.Infrastructure.Migrations
{
	...
	public partial class AddArchiveAndHousekeepingFoundation : Migration
	{
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.DropColumn(name: "IsArchived", table: "documents");
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.DropColumn(name: "ArchivedAt", table: "personal_tasks");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "notes");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "memory_entries");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "documents");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "cards");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "card_chat_links");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "calendar_sources");

			migrationBuilder.DropColumn(name: "ArchivedAt", table: "calendar_events");

...
public class ProblemDetailsMapperTests
{
	...
	{
		var error = new Error(
		    DomainErrorCodes.Auth.UserDisabled,
	...
	public void FromError_DatabaseUnavailable_MapsTo503()
	{
		...
		Assert.Equal(DomainErrorCodes.Infrastructure.DatabaseUnavailable, details.Extensions["code"]);
	}
	...
	{
		var error = new Error(
		    DomainErrorCodes.Projects.NotFound, "Project not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Projects.Archived, "Project is archived.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Projects.OwnerRequired, "Owner role required.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Projects.LastOwnerRemovalDenied, "Cannot remove last owner.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Projects.MembershipDenied, "Membership denied.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Projects.MemberDuplicate, "Already a member.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Membership.NotFound, "Member not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Membership.RoleDenied, "Role denied.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Columns.NotFound, "Column not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Columns.InvalidPosition, "Invalid positions.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Columns.DeleteNonEmpty, "Column has cards.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Columns.ArchivedProjectDenied, "Project archived.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.NotFound, "Card not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.Archived, "Card is archived.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.InvalidType, "Invalid card type.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.InvalidAssignee, "Invalid assignee.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.DuplicateAssignee, "Already assigned.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.InvalidParent, "Invalid parent.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.ParentCycle, "Cycle detected.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.BlockedMoveWarning, "Card has blockers.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Cards.ConcurrencyMismatch, "Card modified.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Checklist.ItemNotFound, "Item not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Checklist.InvalidPosition, "Invalid position.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Checklist.InvalidAssignee, "Invalid assignee.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Comments.NotFound, "Comment not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Comments.Archived, "Comment is archived.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Attachments.NotFound, "Attachment not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Attachments.UnsupportedContentType, "Unsupported type.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Attachments.FileTooLarge, "File too large.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Attachments.FileStoreUnavailable, "File store down.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Mentions.UserNotFound, "User not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Specs.NotFound, "Spec not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Specs.DocumentVersionNotFound, "Version not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Specs.MarkdownPayloadTooLarge, "Payload too large.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Specs.CardDocumentProjectMismatch, "Project mismatch.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Plans.NotFound, "Plan not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Plans.DocumentVersionNotFound, "Version not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Plans.MarkdownPayloadTooLarge, "Payload too large.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Plans.CardDocumentProjectMismatch, "Project mismatch.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Relationships.NotFound, "Relationship not found.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Relationships.Duplicate, "Already exists.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Relationships.CrossProjectDenied, "Cross project.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Relationships.Cycle, "Cycle detected.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Relationships.SelfDenied, "Self relationship.");
	...
	{
		var error = new Error(
		    DomainErrorCodes.Relationships.ArchiveImpactConfirmRequired, "Confirm.");

...
public class ProblemDetailsMapperTests
{
    ...
    {
        var error = new Error(DomainErrorCodes.Auth.UserDisabled, "User account is disabled.");
        ...
        Assert.Equal(DomainErrorCodes.Auth.UserDisabled, details.Extensions["code"]);
    }
    ...
    public void FromError_AuthAdminSeedNotConfigured_MapsTo500()
    {
        ...
        Assert.Equal(DomainErrorCodes.Auth.AdminSeedNotConfigured, details.Extensions["code"]);
    }
    ...
    public void FromError_AuditWriteFailed_MapsTo500()
    {
        ...
        Assert.Equal(DomainErrorCodes.Infrastructure.AuditWriteFailed, details.Extensions["code"]);
    }

    [Fact]
    public void FromError_UnknownCode_MapsTo400()
    {
        var error = new Error("UNKNOWN_CODE", "Some unknown error.");
    ...
    {
        var error = new Error(DomainErrorCodes.Projects.NotFound, "Project not found.");
        ...
        Assert.Equal(DomainErrorCodes.Projects.NotFound, details.Extensions["code"]);
    ...
    {
        var error = new Error(DomainErrorCodes.Projects.Archived, "Project is archived.");
    ...
    {
        var error = new Error(DomainErrorCodes.Projects.OwnerRequired, "Owner role required.");
    ...
    public void FromError_ProjectLastOwnerRemovalDenied_MapsTo400()
    {
        ...
        Assert.Equal(
            "https://hydraforge.local/errors/project-last-owner-removal-denied",
            details.Type
        );
    }
    ...
    {
        var error = new Error(DomainErrorCodes.Projects.MembershipDenied, "Membership denied.");
    ...
    {
        var error = new Error(DomainErrorCodes.Projects.MemberDuplicate, "Already a member.");
    ...
    {
        var error = new Error(DomainErrorCodes.Membership.NotFound, "Member not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Membership.RoleDenied, "Role denied.");
    ...
    {
        var error = new Error(DomainErrorCodes.Columns.NotFound, "Column not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Columns.InvalidPosition, "Invalid positions.");
    ...
    {
        var error = new Error(DomainErrorCodes.Columns.DeleteNonEmpty, "Column has cards.");
    ...
    {
        var error = new Error(DomainErrorCodes.Columns.ArchivedProjectDenied, "Project archived.");
        ...
        Assert.Equal("Project is archived", details.Title);
        Assert.Equal(
            "https://hydraforge.local/errors/column-archived-project-denied",
            details.Type
        );
    }
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.NotFound, "Card not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.Archived, "Card is archived.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.InvalidType, "Invalid card type.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.InvalidAssignee, "Invalid assignee.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.DuplicateAssignee, "Already assigned.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.InvalidParent, "Invalid parent.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.ParentCycle, "Cycle detected.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.BlockedMoveWarning, "Card has blockers.");
    ...
    {
        var error = new Error(DomainErrorCodes.Cards.ConcurrencyMismatch, "Card modified.");
    ...
    {
        var error = new Error(DomainErrorCodes.Checklist.ItemNotFound, "Item not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Checklist.InvalidPosition, "Invalid position.");
    ...
    {
        var error = new Error(DomainErrorCodes.Checklist.InvalidAssignee, "Invalid assignee.");
    ...
    {
        var error = new Error(DomainErrorCodes.Comments.NotFound, "Comment not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Comments.Archived, "Comment is archived.");
    ...
    {
        var error = new Error(DomainErrorCodes.Attachments.NotFound, "Attachment not found.");
    ...
    public void FromError_AttachmentUnsupportedContentType_MapsTo415()
    {
        ...
        Assert.Equal(
            "https://hydraforge.local/errors/attachment-unsupported-content-type",
            details.Type
        );
    }
    ...
    {
        var error = new Error(DomainErrorCodes.Attachments.FileTooLarge, "File too large.");
    ...
    public void FromError_AttachmentFileStoreUnavailable_MapsTo503()
    {
        ...
        Assert.Equal("Service unavailable", details.Title);
        Assert.Equal(
            "https://hydraforge.local/errors/attachment-file-store-unavailable",
            details.Type
        );
    }
    ...
    {
        var error = new Error(DomainErrorCodes.Mentions.UserNotFound, "User not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Specs.NotFound, "Spec not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Specs.DocumentVersionNotFound, "Version not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Specs.MarkdownPayloadTooLarge, "Payload too large.");
    ...
    public void FromError_SpecCardDocumentProjectMismatch_MapsTo409()
    {
        ...
        Assert.Equal(
            "https://hydraforge.local/errors/card-document-project-mismatch",
            details.Type
        );
    }
    ...
    {
        var error = new Error(DomainErrorCodes.Plans.NotFound, "Plan not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Plans.DocumentVersionNotFound, "Version not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Plans.MarkdownPayloadTooLarge, "Payload too large.");
    ...
    {
        var error = new Error(DomainErrorCodes.Relationships.NotFound, "Relationship not found.");
    ...
    {
        var error = new Error(DomainErrorCodes.Relationships.Duplicate, "Already exists.");
    ...
    {
        var error = new Error(DomainErrorCodes.Relationships.CrossProjectDenied, "Cross project.");
        ...
        Assert.Equal(
            "https://hydraforge.local/errors/relationship-cross-project-denied",
            details.Type
        );
    }
    ...
    {
        var error = new Error(DomainErrorCodes.Relationships.Cycle, "Cycle detected.");
    ...
    {
        var error = new Error(DomainErrorCodes.Relationships.SelfDenied, "Self relationship.");
    ...
    public void FromError_RelationshipArchiveImpactConfirmRequired_MapsTo409()
    {
        ...
        Assert.Equal(
            "https://hydraforge.local/errors/card-archive-impact-confirm-required",
            details.Type
        );
    }
}

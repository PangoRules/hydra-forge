...
public class UtcDateTimeConverterTests
{
    ...
    {
        var payload = JsonSerializer.Deserialize<Payload>("""{"Value":"2028-10-26T00:00:00Z"}""", Options);
    ...
    public void Read_ExplicitNonZeroOffset_IsConvertedToUtcNotLocal()
    {
        ...
        var payload = JsonSerializer.Deserialize<Payload>("""{"Value":"2028-10-26T00:00:00+00:00"}""", Options);
    ...
    public void Read_NonUtcOffset_ConvertsClockTimeToUtcEquivalent()
    {
        ...
        var payload = JsonSerializer.Deserialize<Payload>("""{"Value":"2028-10-26T00:00:00-05:00"}""", Options);
    ...
    public void Read_NoOffset_StaysUnspecified()
    {
        ...
        var payload = JsonSerializer.Deserialize<Payload>("""{"Value":"2028-10-26T00:00:00"}""", Options);
    ...
    {
        var json = JsonSerializer.Serialize(new Payload(new DateTime(2028, 10, 26, 0, 0, 0, DateTimeKind.Utc)), Options);

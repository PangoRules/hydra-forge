...
public class NotificationEventTests
{
    ...
    private class TestableSignalRConnectionManager : SignalRConnectionManager
    {
        private readonly AppState _appState;
        public TestableSignalRConnectionManager(AppState appState, ErrorCollector errorCollector)
            : base(appState, errorCollector)
        {
            _appState = appState;
        }

...
- Plans 4-6 (card modal panels, specs/plans, realtime SignalR, polish/hardening) remain. Two additional plans exist but not yet executed: `docs/plans/2026-06-25-phase-3-card-modal-hardening.md` (useApi try/catch, version ownership, shared utilities, a11y) and `docs/plans/2026-06-25-phase-3-e2e-testing-foundation.md` (Playwright). Plan 4's Task 16 depends on the hardening plan's Task 2/3.

...
- [x] **Step 1: Add `openCardId` to board Pinia store** (done)
- [x] **Step 2: Write `openCardId` from `board.vue` instead of local ref** (done)
- [x] **Step 3: Read `openCardId` in `chatDock` store on new chat** (done)
- [x] **Step 4: Verify typecheck + lint** (done)
...
Created `docs/manual-validation/2026-08-05-chat-dock-improvements-matrix.md` with TC-1 through TC-16.

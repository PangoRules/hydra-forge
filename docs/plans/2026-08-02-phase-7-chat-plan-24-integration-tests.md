...
- [ ] Manual validation matrix: Tasks 1–17 are already pre-consolidated at `docs/manual-validation/2026-08-04-phase-7-chat-tasks-1-17-matrix.md` (done ahead of schedule during the Plan 17 wrap-up). Fold that content plus the per-plan files written during plans 18–23 (`docs/manual-validation/2026-08-02-phase-7-chat-plan-{18,19,19b,20,21,22,23}-*-matrix.md` — note Plan 19b was inserted 2026-08-06 and Plan 20 was renamed to `plan-20-web-card-popup-chat-project-chats` the same day) into `docs/archive/manual-validation/<ship-date>-phase-7-chat-matrix.md`, then delete all the source files in the same pass (per repo convention — don't leave them lying around after consolidation)
